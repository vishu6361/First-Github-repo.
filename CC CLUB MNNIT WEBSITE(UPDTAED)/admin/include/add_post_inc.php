...
$sql1="SELECT * FROM posts";
	...
	if($updated==1){
		include_once"image_upload_inc.php";
			...
			$sql2="UPDATE posts SET image_name='$nameoffile',image_path='$target_file_dir' WHERE s_no=$connector";
			...
			mysqli_query($conn,$sql1);
			$sql2="UPDATE posts SET image_name='$nameoffile',image_path='$target_file_dir' WHERE s_no=$max";
			mysqli_query($conn,$sql2);
